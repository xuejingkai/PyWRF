...
def draw_geogrid(file,var,level=None,cmap=cmaps.ncl_default):
    ...
    axe.set_extent([121, 122, 30.8, 31.6], crs=ccrs.PlateCarree())
    ...
    gl.ylocator = mticker.FixedLocator(np.arange(30.8, 31.7, 0.2))
    ...
    axe.plot(121.37,31.1,"o",color="k",markersize=5,zorder=1,label="闵行")
    axe.plot(121.45454,31.39692,"X",color="k",markersize=5,zorder=1,label="宝山")
    axe.plot(121.25,31.37,"*",color="k",markersize=5,zorder=1,label="嘉定")
    axe.plot(121.7833,31.05,"D",color="k",markersize=5,zorder=1,label="南汇")
    ...
    l1=plt.legend(proxy, [level[i] for i in classification], loc="upper right", bbox_to_anchor=(1.3,1),labelspacing=1,
               prop=FontProperties(fname="./font/SimSun.ttf", size=12))
    l2=plt.legend(loc="lower right",prop=FontProperties(fname="./font/SimSun.ttf", size=12),bbox_to_anchor=(1.212,0.4))
    axe.add_artist(l1)
    ######################
    fig.show()
    plt.show()
...
if __name__ == '__main__':
    ...
    draw_geogrid(r"D:\Data\WRF-Chem_Files\WRF-Chem_Simulation\ucm_modifiedParam_4\geo_em.d03.nc","LU_INDEX",
                 {1:"针叶林",2:"阔叶林",5:"混叶林",6:"封闭灌木丛",7:"开放灌木丛",10:"草地",11:"湿地",12:"耕地", 13:"城市", 14:"耕地植被"
                     ,15:"冰雪",16:"植被稀少的土地",17:"水",19:"荒原",31:"低密度人口",32:"高密度人口",33:"工商业区"},

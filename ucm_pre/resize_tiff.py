...
if __name__ == '__main__':
    for i in range(1,8,1):
        filename="radio_L1TP_119038_20170308_b"+str(i)+".tif"
        outputname="resize_L1TP_119038_20170308_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\2_radiometric",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Float32)
    for i in range(1,8,1):
        filename="radio_L1TP_118039_20170402_b"+str(i)+".tif"
        outputname="resize_L1TP_118039_20170402_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\2_radiometric",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Float32)
    for i in range(1,8,1):
        filename="radio_L1TP_118038_20170402_b"+str(i)+".tif"
        outputname="resize_L1TP_118038_20170402_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\2_radiometric",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Float32)
    for i in range(10,12,1):
        filename="15m_119038_b"+str(i)+".tif"
        outputname="resize_L1TP_119038_20170308_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\3_b10b11_resize",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Int16)
    for i in range(10,12,1):
        filename="15m_118038_b"+str(i)+".tif"
        outputname="resize_L1TP_118038_20170402_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\3_b10b11_resize",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Int16)
    for i in range(10,12,1):
        filename="15m_118039_b"+str(i)+".tif"
        outputname="resize_L1TP_118039_20170402_b"+str(i)+".tif"
        resize_tiff(os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\3_b10b11_resize",filename),
                    os.path.join(r"D:\Data\WRF-Chem_Files\Land_Use_Data\LCZ_Shanghai\Landset8\2_Prepare\4_resize",outputname),
                    gdal.GDT_Int16)
...
download_path="D:\Data\WRF-Chem Files\Land Cover Data\QingHua_Landuse_2017v1"
...
for i in bs.find_all('tr'):
    ...
    with open(os.path.join(download_path,download_url.split("fromglc2017/")[1]), 'wb') as f:
        print(os.path.join(download_path,download_url.split("fromglc2017/")[1]))

...
l_x,r_x,b_y,t_y=    120, 123, 30, 32.5    #图片显示范围，分别是左右下上
...
#设置数据的变量，时间，高度
path=r'D:\Data\WRF-Chem Files\WRF-Chem Simulation\1.Test\wrfout_1'     #读取文件的路径
var_contourf, var_contour=     'PM10','rh'    #填充的变量和绘制等高线的变量
chem_w=                         0          #摩尔质量，如果无需摩尔质量输入小于等于0的数字
var_u,var_v=                   'U10','V10'    #风速的经度方向和纬度方向
timelist=range(56,69,2)                   #时间的列表，起始，重点，间隔多少
...
level=np.arange(0, 50, 5)                  #填色的最小值，最大值和间隔
ticks=np.arange(0, 50, 10)                    #设置colorbar的ticks，如果不需要写成None

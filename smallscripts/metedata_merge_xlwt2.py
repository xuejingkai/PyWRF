...
#           脚本中的相对湿度计算公式来自：https://en.wikipedia.org/wiki/Dew_point#cite_note-19
#           使用的近似公式为：August-Roche-Magnus Formula
#           参考文献：
#           1.公式原文 Magnus G. Versuche über die Spannkräfte des Wasserdampfs[J]. Annalen der Physik, 1844, 137(2): 225-247.
#           2.Alduchov O A, Eskridge R E. Improved Magnus form approximation of saturation vapor pressure[J]. Journal of Applied Meteorology and Climatology, 1996, 35(4): 601-609.
#           3.Buck A L. New equations for computing vapor pressure and enhancement factor[J]. Journal of Applied Meteorology and Climatology, 1981, 20(12): 1527-1532.
        ...
        if first == True:
            ...
            if date < datetime(2018, 5, 31):
                ...
                if whetherheader == True:
                    ...
                    valuelist.append(
                        [onelist[0], onelist[7], onelist[8], onelist[9], onelist[10], onelist[11], onelist[12],
                         onelist[13], onelist[14]])
                else:
                    valuelist.insert(count - 1 + indexnum * count,
                                     [onelist[0], onelist[7], onelist[8], onelist[9], onelist[10], onelist[11],
                                      onelist[12], onelist[13], onelist[14]])
            else:
                # 写入头文件
                if whetherheader == True:
